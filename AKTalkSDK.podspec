#
#  Be sure to run `pod spec lint AKTalkSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "AKTalkSDK"
  spec.version      = "2.1.5"
  spec.summary      = "A short description of AKTalkSDK."
  ...
  # Or just: spec.author    = "zhongbin"
  # spec.authors            = { "zhongbin" => "zhongbin.wen@akuvox.com" }
  # spec.social_media_url   = "https://twitter.com/zhongbin"
  ...
  #spec.source       = { :git => "https://github.com/Akuvox/AKTalkSDK.git", :tag => "#{spec.version}" }
